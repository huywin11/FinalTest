                                            ...
                                            <tr>
                                                <td valign="top" style="padding:28px 48px 12px">
                                                    <div style="color:#636363;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left">
                                                        ...
                                                        function code_to_country_customer_completed_order( $code ){
                                                        ...
                                                        function renderEmailLineCustomerCompletedOrder($label,$para){
                                                            if($para!=null && $para!='') {
                                                        ...
                                                        $billing_country = code_to_country_customer_completed_order($order->get_billing_country()) ?? '';
                                                        ...
                                                        renderEmailLineCustomerCompletedOrder($salutationLabel,$billing_salutation);
                                                        renderEmailLineCustomerCompletedOrder($titleLabel,$billing_title);
                                                        renderEmailLineCustomerCompletedOrder($firstNameLabel,$billing_first_name);
                                                        renderEmailLineCustomerCompletedOrder($lastNameLabel,$billing_last_name);
                                                        renderEmailLineCustomerCompletedOrder($companyLabel,$billing_company);
                                                        renderEmailLineCustomerCompletedOrder($divisionLabel,$billing_division);
                                                        renderEmailLineCustomerCompletedOrder($addressLabel,$billing_address_1);
                                                        renderEmailLineCustomerCompletedOrder($postalCodeLabel,$billing_postcode);
                                                        renderEmailLineCustomerCompletedOrder($cityLabel,$billing_city);
                                                        renderEmailLineCustomerCompletedOrder($countryLabel,$billing_country);
                                                        renderEmailLineCustomerCompletedOrder($phoneLabel,$billing_phone);
                                                        renderEmailLineCustomerCompletedOrder($faxLabel,$billing_fax);
                                                        renderEmailLineCustomerCompletedOrder($emailLabel,$billing_email);
                                                        renderEmailLineCustomerCompletedOrder($couponCodeLabel,$billing_coupon_code);
                                                        renderEmailLineCustomerCompletedOrder($VATNumberLabel,$billing_vat_number);
                                                        renderEmailLineCustomerCompletedOrder($orderNumberLabel,$billing_order_number);
                                                        renderEmailLineCustomerCompletedOrder($messageLabel,$billing_message);
                                                        ...
                                                        if ( $order->has_shipping_address() && get_post_meta($order_id,'order_custom_ship_to_different_address',true)==1) {
                                                            ...
                                                            $shipping_country = code_to_country_customer_completed_order($order->get_shipping_country()) ?? '';
                                                            ...
                                                            renderEmailLineCustomerCompletedOrder($salutationLabel,$shipping_salutation);
                                                            renderEmailLineCustomerCompletedOrder($titleLabel,$shipping_title);
                                                            renderEmailLineCustomerCompletedOrder($firstNameLabel,$shipping_first_name);
                                                            renderEmailLineCustomerCompletedOrder($lastNameLabel,$shipping_last_name);
                                                            renderEmailLineCustomerCompletedOrder($companyLabel,$shipping_company);
                                                            renderEmailLineCustomerCompletedOrder($divisionLabel,$shipping_division);
                                                            renderEmailLineCustomerCompletedOrder($addressLabel,$shipping_address_1);
                                                            renderEmailLineCustomerCompletedOrder($postalCodeLabel,$shipping_postcode);
                                                            renderEmailLineCustomerCompletedOrder($cityLabel,$shipping_city);
                                                            renderEmailLineCustomerCompletedOrder($countryLabel,$shipping_country);
                                                            renderEmailLineCustomerCompletedOrder($phoneLabel,$shipping_phone);
                                                            renderEmailLineCustomerCompletedOrder($faxLabel,$shipping_fax);
                                                            renderEmailLineCustomerCompletedOrder($emailLabel,$shipping_email);
                                                            renderEmailLineCustomerCompletedOrder($couponCodeLabel,$shipping_coupon_code);
                                                            renderEmailLineCustomerCompletedOrder($VATNumberLabel,$shipping_vat_number);
                                                            renderEmailLineCustomerCompletedOrder($orderNumberLabel,$shipping_order_number);
                                                            renderEmailLineCustomerCompletedOrder($messageLabel,$shipping_message);
                                                        }
